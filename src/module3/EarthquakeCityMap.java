...
public class EarthquakeCityMap extends PApplet {
    ...
    private void addKey() {
        ...
        String h = "5.0+ Magnitude";
        String m = "4.0+ Magnitude";
        String l = "Below 4.0";


        fill(200, 200, 200);
        rect(25, 50, 160, 250, 3, 3, 3, 3);

        fill(50);
        text("Earthquake Key", 60, 80);  // Text wraps within text box

        fill(0, 0, 255);
        ellipse(50, 120, 15, 15);
        fill(50);
        text(h, 70, 127.5f);  // Text wraps within text box

        fill(255, 255, 0);
        ellipse(50, 190, 10, 10);
        fill(50);
        text(m, 70, 195);  // Text wraps within text box

        fill(255, 0, 0);
        ellipse(50, 260, 5, 5);
        fill(50);
        text(l, 70, 262.5f);  // Text wraps within text box
    }
}
